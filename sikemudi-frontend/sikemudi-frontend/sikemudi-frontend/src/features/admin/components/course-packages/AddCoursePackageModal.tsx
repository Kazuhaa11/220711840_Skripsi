...
interface AddCoursePackageModalProps {
  opened: boolean;
...
const priceFields: {
  ...
  {
    field: "priceSimNoPickup",
    label: "SIM + Tanpa Jemput",
    placeholder: "1200000",
  },
  {
    field: "priceSimPickup",
    label: "SIM + Antar Jemput",
    placeholder: "1350000",
  },
];

export default function AddCoursePackageModal({
  opened,
  values,
  loading = false,
  onChange,
  onClose,
  onSubmit,
}: AddCoursePackageModalProps) {
  return (
    <Modal
      opened={opened}
      onClose={onClose}
      size="xl"
      title={<span className="text-white">Tambah Paket Kursus</span>}
      description={
        <span className="text-blue-100">
          Lengkapi data paket, durasi, dan seluruh varian harga.
        </span>
      }
      ...
      <div className="pr-1">
        <div className="grid gap-4 lg:grid-cols-2">
          ...
          <Input
            ...
            placeholder="Contoh: Paket 6 Jam"
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-4 lg:col-span-2">
            <div className="mb-4">
              ...
              <p className="mt-1 text-sm text-slate-500">
                Isi semua varian harga. Peserta akan memilih kebutuhan antar jemput dan SIM saat booking.
              </p>
            </div>
          ...
          <TextArea
            ...
            rows={4}
            placeholder="Tuliskan deskripsi lengkap paket kursus..."
            labelClassName={labelClassName}
