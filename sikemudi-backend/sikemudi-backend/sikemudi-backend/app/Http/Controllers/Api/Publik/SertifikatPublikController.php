...
class SertifikatPublikController extends Controller
{
    public function verifikasi(string $kode): JsonResponse
    {
        ...
        if ($certificate->status !== 'Terbit') {
            return response()->json([
                'success' => false,
                'message' => 'Sertifikat ditemukan, tetapi tidak berstatus aktif/terbit.',
                'data' => [
                    'is_valid' => false,
        ...
        return response()->json([
            'success' => true,
            'message' => 'Sertifikat valid dan terdaftar pada sistem SIKEMUDI.',
            'data' => [
                'is_valid' => true,
